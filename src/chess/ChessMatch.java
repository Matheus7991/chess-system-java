...
public class ChessMatch {
	...
	public ChessPiece getEnPassanrVulnerable() {
	...
	public boolean[][] possibleMoves(ChessPosition sourcePosition) {
		...
		validateSoucerPosition(position);
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		validateSoucerPosition(source);
		validateTargetPosition(source, target);
		Piece capturedPiece = makeMove(source, target);
		
		if(testCheck(currentPlayer)) {
			undonMove(source, target, capturedPiece);
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if(!type.equals("B") && !type.equals("N") && !type.equals("R") && !type.equals("Q")) {
			throw new InvalidParameterException("Tipo inválido da promoção");
		}
	...
	private void undonMove(Position source, Position target, Piece capturedPiece) {
